<template>
    <tr>
        ...
        <td>
            ...
            <input v-if="attr_value_type == Number" v-model.lazy="attr_value" type="number" class="form-control form-control-sm">
            <InputTrueFalse v-if="attr_value_type == Boolean" v-model="attr_value" :canbenull="true" class="form-control form-control-sm" />
        </td>
    </tr>
</template>
