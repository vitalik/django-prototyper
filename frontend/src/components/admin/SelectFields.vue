    ...
    <div class="card card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6" v-click-outside="on_outside_click">
                ...
                <div v-if="edit_mode" class="card card-body mt-1" style="position: absolute; width: 340px; z-index: 1000;">
                    <div>
    ...
    methods: {
        toggle_field(name) {
            if (_.includes(this.selected_fields, name))
                this.selected_fields = _.filter(this.selected_fields, i => (i != name))
            else {
                if (this.single)
